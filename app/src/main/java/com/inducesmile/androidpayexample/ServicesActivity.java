...
public class ServicesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      viewPager= (ViewPager) findViewById(R.id.view_pager);
        ...
        GridLayoutManager mGrid = new GridLayoutManager(ServicesActivity.this, 2);
        ...
        ShopRecyclerViewAdapter shopAdapter = new ShopRecyclerViewAdapter(ServicesActivity.this, getAllProductsOnSale());
    ...
    private List<ProductObject> getAllProductsOnSale(){
        ...
        products.add(new ProductObject(1, "Request Electrician", R.drawable.productonesmall, "Beautiful sleek black top for casual outfit and evening walk", 20, 38, "Black"));
        products.add(new ProductObject(1, "Request Plumber", R.drawable.producttwo, "Beautiful sleek black top for casual outfit and evening walk", 20, 38, "Black"));
       return products;
    }
    /**
     * View pager adapter
